...
let c = () => {
  return axios({method: 'post', url:'http://cop-classifier/image', body: {url: 'http://i.imgur.com/nwertuO.jpg'}})
  .then((res) => {
    console.log('response keys: ', Object.keys(res))
    console.log('res body person: ', res.person)
    console.log('res body result: ', res.result)
  })
  .catch((err) => {
...
let a = () => {
  ...
  .then((res) => {
    console.log('response keys: ', Object.keys(res))
    console.log('response data person: ', res.data.person)
